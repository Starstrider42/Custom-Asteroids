namespace Starstrider42.CustomAsteroids
{
    ...
    internal class PeriRange : ValueRange
    {
        ...
        /// <summary>
        /// Assigns situation-specific default values to the PeriRange. The given values will be
        ...
        internal PeriRange (Distribution dist, Type type = Type.Argument,
        ...
        /// <summary>Defines the parametrization of orbit orientation that is used.</summary>
        internal enum Type
        {
            Argument,
            Longitude
