...
{
    /// <summary>
    /// Represents a persistence-safe collection of words with assigned weights. For persistance
    /// purposes, the collection can be viewed as a collection of strings, with each string encoding
    /// both word and weight.
    /// </summary>
    ///
    ...
    ///
    /// <typeparam name="Dummy">Required for proper ConfigNode handling. Only Proportions&lt;string&rt;
    /// will work correctly.</typeparam>
    internal class Proportions<Dummy> : System.Collections.IList, IEnumerable<string>
    {
        ...
        /// <exception cref="ArgumentException">Thrown if any element of <c>buffer</c> does not
            ...
            if (inputTemplate.Match (input).Groups [0].Success) {
                ...
                if (!double.TryParse (parsed ["rate"].ToString (), out rate)) {
                    throw new ArgumentException (
                        Localizer.Format ("#autoLOC_CustomAsteroids_ErrorProportionBadRate",
                                          parsed ["rate"]));
                }
        ...
        /// <summary>
        /// Converts a word and weight into a string in the format "[weight] [word]". Does not
        /// throw exceptions.
        /// </summary>
        ///
        ...
        /// the state of this object shall be reflected in the returned value. On the other hand,
        /// the returned value cannot be used to alter the state of this object. This method does
        /// not throw exceptions.</summary>
        ///
        ...
        /// <summary>
        /// An enumerator that visits each word-weight pair in this object. The enumerator's methods
        /// are expressed in terms of strings of the form "[weight] [word]", and may be used to
        /// traverse the persistent representation of this object.
        /// </summary>
