...
namespace Starstrider42.CustomAsteroids
{
    internal sealed class FixedRateSpawner : AbstractSpawner
    {
        ...
        {
            // Yay for memoryless distributions -- we don't care how long it's been since an
            // asteroid was detected
            resetAsteroidSearches ();
        }

        /// <summary>
        /// Forgets this spawner's previous state, recalculating when the next asteroid will be
        /// detected.
        /// </summary>
