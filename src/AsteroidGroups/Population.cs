...
namespace Starstrider42.CustomAsteroids
{
    ...
    internal sealed class Population : AbstractAsteroidSet
    {
        ...
        /// inside the Sun, causing the game to immediately delete the object with the orbit.
        ...
        internal Population ()
        {
            ...
            orbitSize = new SizeRange (ValueRange.Distribution.LogUniform,
                                       SizeRange.Type.SemimajorAxis);
            ...
            orbitPhase = new PhaseRange (ValueRange.Distribution.Uniform, min: 0.0, max: 360.0,
                                         type: PhaseRange.PhaseType.MeanAnomaly,
                                         epoch: PhaseRange.EpochType.GameStart);
        ...
        /// </summary>
        ///
        /// <param name="longitude">The angle between the reference direction (coordinate x-axis)
        /// and the projection of a position onto the x-y plane, in degrees. May be mean, eccentric,
        /// or true longitude.</param>
        ...
        ///
        /// <returns>The angle between the periapsis point and a position in the planet's orbital
        /// plane, in degrees. Will be mean, eccentric, or true anomaly, corresponding to the type
        /// of longitude provided.</returns>
